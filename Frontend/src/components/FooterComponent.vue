<template>
  <footer class="">
    ...
    <div class="max-w-5xl w-3/4 mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mt-8 text-sm md:text-md">
        <hr class="border-t-2 border-b-pink-200 my-2 w-full" />
        <p>© 2024 Kos1la. All rights reserved.</p>
        <p class="mt-2">
          Licensed under the
          <a href="https://opensource.org/licenses/MIT" class="text-blue-400 hover:text-blue-300"
            >MIT License</a
          >
        </p>
      </div>
